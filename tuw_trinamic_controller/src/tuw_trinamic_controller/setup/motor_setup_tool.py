...
from tuw_trinamic_controller.configuration.motor_configuration_tool import get_motor_configuration
from tuw_trinamic_controller.configuration.motor_configuration_tool import set_motor_configuration
