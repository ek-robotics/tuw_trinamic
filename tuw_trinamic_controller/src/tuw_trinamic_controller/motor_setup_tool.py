...
from tuw_trinamic_controller.motor_configuration_tool import get_motor_configuration
from tuw_trinamic_controller.motor_configuration_tool import set_motor_configuration
